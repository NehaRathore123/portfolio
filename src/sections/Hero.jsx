...
=======
            <div className="text-2xl md:text-5xl font-extrabold mb-10 h-[1.2em] flex items-center justify-center lg:justify-start">
                ...
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  {[
                    ...
                    <motion.div
                      ...
                      animate={{ 
                        opacity: 1,
                        x: window.innerWidth < 768 ? badge.x * 0.5 : badge.x, 
                        y: window.innerWidth < 768 ? badge.y * 0.5 : badge.y,
                        translateY: [0, -15, 0]
                      }}
                  ...
                  <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20">
                     <motion.line 
                        ...
                        x1="50%" y1="50%" x2={window.innerWidth < 768 ? "35%" : "20%"} y2={window.innerWidth < 768 ? "35%" : "20%"} stroke="#e91e63" strokeWidth="1" 
                     />
                     <motion.line 
                        initial={{ pathLength: 0 }}
                        animate={{ pathLength: 1 }}
                        transition={{ duration: 2, delay: 1.5 }}
                        x1="50%" y1="50%" x2={window.innerWidth < 768 ? "65%" : "80%"} y2={window.innerWidth < 768 ? "65%" : "80%"} stroke="#e91e63" strokeWidth="1" 
                     />
                  </svg>
                </div>
              </motion.div>
